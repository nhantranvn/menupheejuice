    ...
    <div className="space-y-6 py-4">
      <section className="surface p-6 sm:p-8">
        ...
        <div className="mt-3 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-4xl font-bold">Cập nhật ảnh thật và nhập món thủ công</h1>
            <p className="mt-3 max-w-3xl text-stone-600">
              Tại đây, bạn có thể thêm món mới bằng tay, tải ảnh thật, đánh dấu hết hàng hoặc xóa các món chưa dùng trong đơn hàng.
            </p>
          </div>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-3xl bg-stone-50 px-5 py-4">
            <p className="text-sm text-stone-500">Tổng số món</p>
            <p className="mt-1 text-2xl font-bold">{totalItems}</p>
          </div>
          <div className="rounded-3xl bg-stone-50 px-5 py-4">
            <p className="text-sm text-stone-500">Đã có ảnh thật</p>
            <p className="mt-1 text-2xl font-bold">{itemsWithImages}</p>
          </div>
          <div className="rounded-3xl bg-stone-50 px-5 py-4">
            <p className="text-sm text-stone-500">Còn thiếu ảnh</p>
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-3">
                          <div>
                            ...
                            <p className="mt-2 text-sm text-stone-500">
                              {item.description ?? "Chưa có mô tả. Bạn có thể cập nhật mô tả sau."}
                            </p>
                          </div>
                          <span
