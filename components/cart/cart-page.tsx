      ...
      <section className="surface p-6 sm:p-8">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold">Món bạn đã chọn</h1>
          </div>
          {!isEmpty ? (
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex items-center gap-3 sm:pt-1">
                    <div className="flex items-center rounded-full border border-stone-200 bg-stone-50 p-1">
                      <button
                        type="button"
                        className="flex h-9 w-9 items-center justify-center rounded-full text-stone-600 transition hover:bg-white"
                    ...
                    <p className="min-w-28 text-right text-base font-semibold text-orange-600">{formatCurrency(item.totalPrice * item.quantity)}</p>
                    <button
                      type="button"
                      className="flex h-10 w-10 items-center justify-center rounded-full border border-stone-200 text-stone-500 transition hover:border-red-200 hover:bg-red-50 hover:text-red-600"
